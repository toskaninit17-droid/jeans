              ...
              try {
                ...
                if (Array.isArray(products) && products.length) {
                  ...
                  products.forEach(function(p){
                   ...
                   var parts = [name];
if (p.selectedColorLabel || p.color) parts.push('اللون: ' + (p.selectedColorLabel || p.color));
if (p.selectedSizeLabel  || p.size ) parts.push('المقاس: ' + (p.selectedSizeLabel  || p.size ));
